...
######################## below are for production####################################################
    text="//t"
    root_dir1="'s
    root_dir2="" #root folder for bcw pdf's
    root_dir3="" #root folder for archiving the excel file
    new_xlsx=""  # root folder for creating the excel file
    dest_folder="" #where archival for both pdf's and .xlsx files go at the end of a successful upload to the sql database
#######################################################################################################
