...
######################## below are for production####################################################
    text="G:/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/10 Data Management/DM Only/abid_success.txt"
    root_dir1="G:/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/08 Monitoring/Enrollment Monitoring/BLD PDFs/" #root folder for bld pdf's
    root_dir2="G:/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/08 Monitoring/Enrollment Monitoring/BCW PDFs/" #root folder for bcw pdf's
    root_dir3="G:/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/10 Data Management/DM Only/" #root folder for archiving the excel file
    new_xlsx="G:/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS\IHD/IH-500 Antibody Identification/10 Data Management/DM Only/IHAB_ELCombine.xlsx"  # root folder for creating the excel file
    dest_folder="G:/USRED_STORAGE/Clinicals/Data Management/IHD IH-500 ABID/" #where archival for both pdf's and .xlsx files go at the end of a successful upload to the sql database
#######################################################################################################
...
#######################################################################################################
    #text=r"//global.bio-rad.com/groups/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/10 Data Management/DM Only/abid_success.txt"
    table_name ="tbl_stg1_EL"

    #path = os.path.abspath(os.path.dirname(os.path.abspath(__file__)))
    #text = os.path.join(path,"//global.bio-rad.com/groups/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/10 Data Management/DM Only/abid_success.txt")
    #root_dir1 = os.path.join(path,"//global.bio-rad.com/groups/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/08 Monitoring/Enrollment Monitoring/BLD PDFs/")
    #root_dir2 = os.path.join(path, "//global.bio-rad.com/groups/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/08 Monitoring/Enrollment Monitoring/BCW PDFs/")
    #root_dir3 = os.path.join(path, "//global.bio-rad.com/groups/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/10 Data Management/DM Only/")
    #new_xlsx = os.path.join(path, "//global.bio-rad.com/groups/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS\IHD/IH-500 Antibody Identification/10 Data Management/DM Only/IHAB_ELCombine.xlsx")
    #dest_folder = os.path.join(path,  "//global.bio-rad.com/groups/USRED_STORAGE/Clinicals/Data Management/IHD IH-500 ABID/")  

    engine = sqlalchemy.create_engine('mssql://USREDAP110/IHAB?driver=SQL+Server+Native+Client+11.0?charset=utf8', encoding = 'utf-8')
