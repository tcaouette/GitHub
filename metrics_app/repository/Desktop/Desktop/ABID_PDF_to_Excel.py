...
######################## below are for production####################################################
    text="//global.bio-rad.com/groups/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/10 Data Management/DM Only/abid_success.txt"
    root_dir1="//global.bio-rad.com/groups/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/08 Monitoring/Enrollment Monitoring/BLD PDFs/" #root folder for bld pdf's
    root_dir2="//global.bio-rad.com/groups/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/08 Monitoring/Enrollment Monitoring/BCW PDFs/" #root folder for bcw pdf's
    root_dir3="//global.bio-rad.com/groups/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS/IHD/IH-500 Antibody Identification/10 Data Management/DM Only/" #root folder for archiving the excel file
    new_xlsx="//global.bio-rad.com/groups/USRED_CLINICAL DATA/CLINTRIALS_IN_PROGRESS\IHD/IH-500 Antibody Identification/10 Data Management/DM Only/IHAB_ELCombine.xlsx"  # root folder for creating the excel file
    dest_folder="//global.bio-rad.com/groups/USRED_STORAGE/Clinicals/Data Management/IHD IH-500 ABID/" #where archival for both pdf's and .xlsx files go at the end of a successful upload to the sql database
#######################################################################################################
